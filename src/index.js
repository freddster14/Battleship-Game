...
function createPlayerGrid(player) {
    ...
    document.querySelectorAll('.ships > button').forEach((button) => {
        button.addEventListener('click', (e) => {
            selectedShip = selectShip(e.target.classList.value)
        })
    });
